              ...
              <div class="row d-flex justify-content-between">
               ...
               {{$post->title}}
                ...
                >
                  ...
                  <div class="user-img">
                    <img src="https://cdn.britannica.com/39/7139-050-A88818BB/Himalayan-chocolate-point.jpg" alt="{{$post->user->name}}"  width="50px"/>
                  </div>
                </div>
              </div>
                      ...
                      <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                          <div class="user justify-content-between d-flex">
                            <div class="thumb">
                              <img src="https://cdn.britannica.com/39/7139-050-A88818BB/Himalayan-chocolate-point.jpg" alt="{{$comment->user->image}}" width="50px">
                            </div>
                            <div class="desc">
                    ...
                    @if($comment->replies->count() > 0)
                      ...
                      <div class="comment-list left-padding">
                        ...
                        >
                          <div class="user justify-content-between d-flex">
                            <div class="thumb">
                              <img src="https://cdn.britannica.com/39/7139-050-A88818BB/Himalayan-chocolate-point.jpg" alt="{{$reply->user->image}}" width="50px"/>
                            </div>
                            <div class="desc">
